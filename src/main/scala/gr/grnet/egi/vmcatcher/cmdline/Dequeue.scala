...
import gr.grnet.egi.vmcatcher.cmdline.common.{KamakiCloudDelegate, ConfDelegate, InsecureSSLDelegate}
import gr.grnet.egi.vmcatcher.cmdline.helper.{DequeueHandlerClassConverter, NotNullValueValidator}
