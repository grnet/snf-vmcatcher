...
package gr.grnet.egi.vmcatcher.cli.shell
 ...
 * One thing the [[gr.grnet.egi.vmcatcher.cli.shell.Shell Shell]] does is to communicate the outcome using `stderr` or `stdout`
 * accordingly.
 *
